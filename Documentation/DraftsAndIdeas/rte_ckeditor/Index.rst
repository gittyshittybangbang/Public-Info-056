...
This is the draft of a documentation for system extension rte_ckeditor. It is
to be merged to the TYPO3 core, a patch already exists in review: https://review.typo3.org/c/59627/

The text is mostly based on work done by Benni Mack with some additions by
Sybille Peters and converted to reST by Sybille Peters.
...
.. important::
   ...
   The draft here is not kept up to date, see latest version in patch
